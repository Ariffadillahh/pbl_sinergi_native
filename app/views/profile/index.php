        ...
        <div class="flex flex-col mx-auto gap-6 mb-8 ">
            ...
            <div class="max-w-xl w-full mx-auto">
                <div class="bg-white shadow-lg rounded-2xl border border-gray-200 overflow-hidden">
                    ...
                    <div class="md:flex gap-4 px-6 space-y-2.5 md:space-y-0 mb-3">

                        <!-- Edit Profile -->
                        <button
                            type="button"
                            id="openModalEditProfile"
                            class="flex items-center justify-center gap-2 w-full cursor-pointer
               text-white font-semibold text-sm py-2.5 rounded-lg shadow-sm
               bg-gradient-to-r from-cyan-500 to-blue-500
               hover:from-cyan-600 hover:to-blue-600
               focus:outline-none focus:ring-4 focus:ring-cyan-300 transition">
                            ...
                            <div class="bg-white text-gray-900 border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
                                <div class="p-4">
                                    <div class="flex items-start space-x-3">
                                        ...
                                        <div class="flex-1">
                                            <div class="text-lg">
                                                <span class="font-semibold text-gray-700 line-clamp-1"><?= htmlspecialchars($_SESSION['full_name']) ?></span>
                                            </div>
                                            <div class="text-sm">
                                        ...
                                        <div class="relative">
                                            <div class="relative inline-block text-left">
                                                ...
                                                <div
                                                    ...
                                                    <button type="button"
                                                        class="flex w-full items-center gap-2 px-4 py-2.5 text-sm font-medium text-red-600 hover:bg-red-50 hover:text-red-700 transition-colors cursor-pointer"
