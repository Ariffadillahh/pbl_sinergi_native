                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center space-x-1">
                                    <span class="text-gray-500">@sumarecon· Sep 28</span>
                                </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center space-x-2">
                                    <span class="font-bold text-black">Fera Ernawati</span>
                                    <span class="text-gray-500">@feraacorp · 21h</span>
                                </div>

                                <div class="mt-1 text-gray-800 text-base">
                                ...
                                <div class="mt-4 flex items-center justify-between text-gray-500 text-sm max-w-sm">
                                    <button class="flex items-center space-x-2 hover:text-blue-600 transition-colors group cursor-pointer">
                                        <div class="p-2 group-hover:bg-blue-100 rounded-full transition-colors">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                                            </svg>
                                        </div>
                                    ...
                                    <button class="flex items-center space-x-2 hover:text-green-500 transition-colors group cursor-pointer">
                                        <div class="p-2 group-hover:bg-green-100 rounded-full transition-colors">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h5M20 20v-5h-5M4 20h16a2 2 0 002-2V6a2 2 0 00-2-2H4a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                            </svg>
                                        </div>
                                        <span>65</span>
                                    </button>

                                    <button class="flex items-center space-x-2 hover:text-red-500 transition-colors group cursor-pointer">
                                        <div class="p-2 group-hover:bg-red-100 rounded-full transition-colors">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                                            </svg>
                                        </div>
