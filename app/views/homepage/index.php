...
<body class="bg-gray-100 h-screen flex">
    ...
    <div class="w-full flex flex-1 justify-center overflow-hidden">
            ...
            <div class="max-w-xl mx-auto px-5 md:p-0 mb-20 md:mb-0">
                <form class="bg-white rounded-2xl p-4 shadow-md" method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div id="image-preview-container" class="relative mt-4 flex justify-center">
                        <img id="preview-image" src="" alt="Image Preview" class="h-44 max-w-full rounded-lg w-auto hidden">

                        <button type="button" id="remove-preview" class="absolute top-1 right-1 size-6 items-center justify-center bg-white hover:bg-gray-200 rounded-full transition-colors hidden">
        ...
        <aside class="hidden lg:block max-w-[360px] p-4 flex-shrink-0 bg-white border-l border-gray-200 ">
            <div class="mt-6">
                <h2 class="font-bold text-lg mb-4">Sponsored</h2>
            </div>
            <div class="h-full overflow-y-auto hide-scrollbar">
                <div class="shadow-2xl rounded-lg p-4">
                    <p class=" py-10">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Magni sunt, modi neque aliquid esse aperiam id expedita quos repudiandae voluptatum provident nulla eveniet quas porro excepturi ducimus vero quasi dolorum!</p>
                    <p class="py-10">Hanya konten di dalam area ini yang akan scroll.</p>
                    <p class="py-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, quod.</p>
                    <p class="py-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, quod.</p>
                    <p class="py-10">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, quod.</p>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const closeButton = document.getElementById('remove-preview');
