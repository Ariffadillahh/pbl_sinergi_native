...
<body>
    <div class="relative flex h-screen overflow-hidden bg-gray-50">
        ...
        <div id="Main-Content-Container" class="flex-1 overflow-y-auto pb-[70px] lg:pb-0 relative h-[100svh]">
            <div class="flex h-[calc(100svh-70px)] lg:h-[100svh] items-center justify-center text-center">
