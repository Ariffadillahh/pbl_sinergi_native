...
<body>
    <div class="w-full h-full overflow-y-auto">
        <div class="w-full p-8 lg:p-12">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10 bg-white p-5 rounded-xl border border-blue-500/60">
                <div class="space-y-1">
                    <h1 class="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight">
                        Discussion Forum
                    </h1>
                    <p class="text-gray-500 text-base md:text-lg font-medium">
                        Find communities, share ideas, and join the conversation.
                    </p>
                </div>
