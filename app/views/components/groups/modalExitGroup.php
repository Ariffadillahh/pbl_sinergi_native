    ...
    <div class="flex min-h-full justify-center p-4 text-center sm:p-0 items-center">
        <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            ...
            <form id="form-exit-forum" action="<?php echo BASEURL; ?>/groups/exit" method="post" class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                ...
                <button id="btn-confirm-exit-forum" type="button" class="inline-flex w-full justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto transition">
                    Yes, I'm sure
                </button>
                <button id="btn-cancel-exit-forum" type="button" class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto transition">
                    Cancel
                </button>
            </form>
