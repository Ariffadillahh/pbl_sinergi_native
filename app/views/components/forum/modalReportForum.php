<div id="modal-report-forum" class="hidden fixed inset-0 z-[9999] justify-center backdrop-blur-sm items-center w-full h-full bg-black/50">
...
<script>
    ...
    btnConfirmReportForum.addEventListener("click", async () => {
        ...
        btnConfirmReportForum.textContent = "Sending...";
        ...
        try {
            ...
            btnConfirmReportForum.textContent = "Send Report";
        }
    });
</script>