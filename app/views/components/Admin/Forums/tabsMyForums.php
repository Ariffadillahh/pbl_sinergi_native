 <div id="content-my-forums" class="<?= $activeTab == 'my-forums' ? '' : 'hidden' ?> p-6">
     <!-- Search -->
     <div class="mb-4">
     ...
     <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-t border-gray-200 pt-4">
         ...
         <?php if ($myTotalPages > 1): ?>
             <div class="flex flex-wrap gap-2">
                 ...
                 <?php else: ?>
                     <a href="<?= getPaginationLink($myPage - 1, 'my-forums', $currentParams) ?>"
                 ...
                 <?php for ($i = 1; $i <= $myTotalPages; $i++): ?>
                     <a href="<?= getPaginationLink($i, 'my-forums', $currentParams) ?>"
