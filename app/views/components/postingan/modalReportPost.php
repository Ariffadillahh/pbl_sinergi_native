<div id="modal-report-post" class="hidden fixed inset-0 z-[99999] justify-center items-center w-full h-full bg-black/50 backdrop-blur-sm">
            ...
            <div class="p-4 md:p-5">
                ...
                <div class="flex justify-center gap-3 mt-6">
                    <button id="btn-confirm-report-post" type="button"
                        class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 cursor-pointer">
                        Send Report
                    </button>
                </div>
            </div>
...
<script>
    ...
    btnConfirmReportPost.addEventListener("click", async () => {
        ...
        btnConfirmReportPost.textContent = "Sending...";
        ...
        try {
            ...
            showMessage("A network error has occurred. Please try again.", "error");
        } finally {
            btnConfirmReportPost.disabled = false;
            btnConfirmReportPost.textContent = "Send Report";
        }
    });
</script>