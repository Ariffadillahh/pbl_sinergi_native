    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function createNotificationHTML(notif) {
            ...
            const messageMap = {
                ...
                DELETE: `<strong>ADMIN</strong> menghapus ${DATA.DATA?.content_type === 'FORUM' ? 'forum' : 'postingan'}.`,
                ...
                WARNING: `<strong>ADMIN</strong> memperingatkan Anda terkait ${DATA.DATA?.content_type === 'FORUM' ? 'forum' : 'postingan'}.`,
