...
<div>
    <nav class="hidden lg:flex h-screen flex-col items-center justify-between w-[84px] shrink-0 bg-gray-200/70 px-5 py-[30px] z-30">
        <ul class="flex flex-col gap-5">
            <li>
                <a href="#"><img src="<?php echo BASEURL; ?>/src/asset/icons/logo-icon.svg" class="flex w-11 h-9 shrink-0" alt="logo"></a>
            </li>
            <li class="group">
                <a href="#" class="size-11 flex shrink-0 items-center justify-center rounded-xl bg-white p-[10px] transition-all duration-300 group-[.active]:bg-blue-600 hover:ring-1 hover:ring-blue-600">
            ...
            <li class="group <?php echo $isForumsActive ? 'active' : ''; ?>">
                <a href="/sinergi/forums" class="size-11 flex shrink-0 items-center justify-center rounded-xl bg-white p-[10px] transition-all duration-300 group-[.active]:bg-blue-600 hover:ring-1 hover:ring-blue-600">
        ...
        <ul class="flex flex-col gap-5">
            <li>
                <a href="#" class="size-11 flex shrink-0 items-center justify-center rounded-xl bg-white p-[10px] transition-all duration-300 group-[.active]:bg-blue-600 hover:ring-1 hover:ring-blue-600">
                    <img src="<?php echo BASEURL; ?>/src/asset/icons/Logout.svg" class="size-6 group-[.active]:hidden" alt="icon">
                </a>
            </li>
            <li>
    ...
    <nav class="lg:hidden fixed bottom-0 left-0 right-0 flex w-full h-[70px] items-center justify-around bg-white border-t border-gray-100 px-5 z-30">
        <a href="#">
            <img src="<?php echo BASEURL; ?>/src/asset/icons/chart-square-grey.svg" class="h-7 w-7" alt="icon">
        </a>
        
        <?php if ($isForumsActive): ?>
            <button id="toggleForumsBtn">
                <img src="<?php echo BASEURL; ?>/src/asset/icons/menu.svg" class="h-7 w-7" alt="icon">
            </button>
        <?php else: ?>
            <a href="<?php echo BASEURL; ?>/forums" id="toggleForumsBtn">
                <img src="<?php echo BASEURL; ?>/src/asset/icons/messages.svg" class="h-7 w-7" alt="icon">
            </a>
        <?php endif; ?>

        <a href="#">
            <img src="<?php echo BASEURL; ?>/src/asset/icons/setting-2.svg" class="h-7 w-7" alt="icon">
        </a>
