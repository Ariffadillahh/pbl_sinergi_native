...
<body>
    <div class="bg-white rounded-xl p-4 drop-shadow">
        <div class="md:flex md:justify-between md:items-center">
            <form class="md:w-md w-full" action="<?= BASEURL ?>/dashboard/anggota/allusers" method="GET">
            ...
            <?php if ($data['totalPages'] > 1) : ?>
                <div class="flex flex-wrap justify-center gap-1">
                    ...
                    function page_url($page, $keyword)
                    {
                        ...
                        return BASEURL . '/dashboard/anggota/allusers' . (empty($params) ? '' : '?' . http_build_query($params));
                    }
